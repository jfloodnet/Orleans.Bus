    ...
    internal class OrleansHostWrapper : IDisposable
    {
        ...
        public bool Run()
        {
            ...
            try
            {
                ...
                if (ok)
                {
                    Console.WriteLine("Successfully started Orleans silo '{0}' as a {1} node.", siloHost.SiloName, siloHost.SiloType);
                }
                else
                {
        ...
        public bool Stop()
        {
            ...
            try
            {
                ...
                Console.WriteLine("Orleans silo '{0}' shutdown.", siloHost.SiloName);
            }
            catch (Exception exc)
            {
                siloHost.ReportStartupError(exc);
